...
import { HeartCrack, HeartHandshake, Sparkles, Share2, RotateCcw, Loader2 } from "lucide-react";
              ...
              {isAiLoading && (
                <div className="p-4 rounded-xl bg-gradient-to-r from-dark-surface via-purple-950/20 to-dark-surface border border-cyber-pink/50 animate-pulse flex flex-col gap-2 shadow-neon-pink/20">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-mono font-bold text-cyber-pink">
                        🔮 【{PERSONAS[personaId].name}】正在连线大模型深度洞察情感走向...
                      </span>
                    </div>
                  ...
                  <p className="text-xs text-slate-400 flex items-center gap-1.5">
                    ...
                    正在为您量身定制最清醒、最护短的恋爱破局 Action Item...
                  </p>
                </div>
              )}

              <div className="p-4 rounded-xl bg-cyber-pink/10 border border-cyber-pink/30 text-xs sm:text-sm text-slate-200 flex flex-col gap-2">
                <div className="flex items-center justify-between">
